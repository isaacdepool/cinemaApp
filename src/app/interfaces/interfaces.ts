...
export class Convert {
    public static toMovies(json: string): Movies {
        return cast(JSON.parse(json), r("Movies"));
    }

    public static moviesToJson(value: Movies): string {
...
const typeMap: any = {
    "Movies": o([
        { json: "Search", js: "Search", typ: a(r("Search")) },
        { json: "totalResults", js: "totalResults", typ: "" },
